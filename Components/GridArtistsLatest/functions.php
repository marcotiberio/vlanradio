...
namespace Flynt\Components\GridArtistsLatest;
...
add_filter('Flynt/addComponentData?name=GridArtistsLatest', function ($data) {
    $postType = POST_TYPE;
...
{
    return [
        'name' => 'GridArtistsLatest',
        'label' => 'Grid: Artists Latest',
        'sub_fields' => [
            [
...
Options::addTranslatable('GridArtistsLatest', [
    [
