...
function registerArtistsTaxonomy()
{
    $labels = [
        'name'                       => _x('Artists', 'Taxonomy General Name', 'flynt'),
        'singular_name'              => _x('Artist', 'Taxonomy Singular Name', 'flynt'),
        'menu_name'                  => __('Artist', 'flynt'),
    ...
    register_taxonomy('artist_taxonomy', ['post'], $args);
}

add_action('init', 'Flynt\\CustomTaxonomies\\registerArtistsTaxonomy');
